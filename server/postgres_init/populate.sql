...
INSERT INTO person (national_id, name, surname, email, password, person_type, phone, birthday)
VALUES (1111, ''mannan'', ''abdul'', ''mannan@gmail.com'', 112233, ''patient'', '' + 905536644231 '', to_date(''2000-07-01'', ''YYYY-MM-DD'')),
...
INSERT INTO department (name, date_est, building)
VALUES (''Oncology'', to_date(''2021-03-01'',''YYYY-MM-DD''), ''A''),
...
INSERT INTO doctor (national_id, room_no, department)
VALUES (2222, 489, ''Oncology''),
       (4444, 302, ''Cardiology''),
       (2233, 432, ''Otolaryngology'');

INSERT INTO laboratorian (national_id, department)
VALUES (3333, ''Oncology''),
       (6666, ''Cardiology''),
       (3344, ''Radiology'');

INSERT INTO test (test_name, department)
VALUES (''blood'', ''Cardiology''),
       (''stones'', ''Radiology''),
       (''x-ray'', ''Radiology''),
       (''urine'', ''Oncology'');

--
INSERT INTO appointment (date, patient_id, doctor_id)
VALUES (to_date(''2021-05-23'', ''YYYY-MM-DD''), 1111, 2222),
...
--
INSERT INTO prescription (prescription_no, prescription_type, date)
VALUES (9, ''A'', ''2021-04-30'');


INSERT INTO component (test_name, comp_name, upper_normality_interval, lower_normality_interval)
VALUES (''blood'', ''calcium'', 25, 0),
       (''blood'', ''Iron'', 50, 0),
...
--
INSERT INTO prescribed_by (prescription_no, appointment_id)
VALUES (9, 9);


INSERT INTO symptom (name, description)
VALUES (''chronic cough'', ''can be result of: smoking, chronic bronchitis, common colds, flu, emphysema, dry mouth,
        asthma, allergies.''),
       ...
       (''nausea'', ''gastrointestinal disorders, food poisoning, motion sickness, dizziness, migraine, fainting,
        low blood sugar ''),
       (''pain in lower abdomen'', ''Crampy pain may be due to gas, indigestion, inflammation or infection, or, in
        women, from menstrual cramps or endometriosis ''),
...
--
INSERT INTO test_assigned_to (appointment_id, laboratorian_id, test_name)
VALUES (9, 3, ''stones'');


INSERT INTO disease (name, description)
VALUES (''flu'', ''infectious disease caused by influenza viruses''),
...
INSERT INTO disease_symptoms (disease_name, symptom_name)
VALUES (''flu'', ''chronic cough''),
       (''GERD'', ''chronic cough''),
       (''GERD'', ''heartburn'');
 ...
 */
--
INSERT INTO doctor_off_days (doctor_id, date)
VALUES (''2222'', to_date(''2021-05-18'', ''YYYY-MM-DD'')),
...
INSERT INTO medicine (name, manufacturer, stock)
VALUES (''parol'', ''pfizer'', 50),
       (''asprin'', ''novartis'', 60),
...
--
INSERT INTO prescription_assigned_to (pharmacist_id, prescription_no)
VALUES (5555, 9);
